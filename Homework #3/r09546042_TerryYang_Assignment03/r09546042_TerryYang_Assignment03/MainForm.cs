...
namespace r09546042_TerryYang_Assignment01
{
    public partial class MainForm : Form
    {
        ...
        public void Delete_Exist_Series()
        {
            Series Delete_Series;
            Delete_Series=Get_Series_by_name(TV_Display.SelectedNode.Text);
            Main_Chart.Series.Remove(Delete_Series);
        ...
        private void TV_Display_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            //PPGV_parameters.SelectedObject = Main_Chart.ChartAreas.FindByName(TV_Display.SelectedNode.Name);
        }
