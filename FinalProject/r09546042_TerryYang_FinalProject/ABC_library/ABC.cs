...
namespace ABC_library
{
    ...
    public class Artificial_Bee_Colony
    {
        #region Date Field
        // hyper parameter
        int num_Of_Pop = 20;
        ...
        #region Constructor
        public Artificial_Bee_Colony(COP.COPBenchmark Cp)
        {
        ...
        public void Onlookers_Bees_Phase()
        {
            ...
            //double[] dartboard = new double[num_Of_Onlooker];
            //int[] locations = new int[num_Of_Food];
            //double sum = 0;
            //int darts_counts = 0;
            //double dart = rnd.NextDouble();

            //// creating darting wheel
            //for (int i = 0; i < num_Of_Onlooker; i++)
            //{
            //    sum += Ratio * fittness[i] * num_Of_Food;
            //    dartboard[i] = sum;
            //}

            //// shooting darts until popsize
            //for (int p = 0; p < num_Of_Onlooker; p++)
            //{
            //    while (dartboard[p] > dart && darts_counts < num_Of_Food) // hit
            //    {
            //        // select 
